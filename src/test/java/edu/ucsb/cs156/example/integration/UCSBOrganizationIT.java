...
public class UCSBOrganizationIT {
  ...
  public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
    ...
    UCSBOrganization organization =
        UCSBOrganization.builder()
            .orgCode("ASA")
            .orgTranslationShort("Alpha Sigma Alpha")
            .orgTranslation("Alpha Sigma Alpha")
            .inactive(false)
            .build();
    ...
    MvcResult response =
        mockMvc
            .perform(get("/api/ucsborganization?code=ASA"))
  ...
  public void an_admin_user_can_post_a_new_UCSBOrganization() throws Exception {
    ...
    UCSBOrganization organization1 =
        UCSBOrganization.builder()
            .orgCode("DEN")
            .orgTranslationShort("Delta Enigma Nous")
            .orgTranslation("Delta Enigma Nous")
            .inactive(true)
            .build();
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/ucsborganization/post?orgCode=DEN&orgTranslationShort=Delta Enigma Nous&orgTranslation=Delta Enigma Nous&inactive=true")
                    .with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
