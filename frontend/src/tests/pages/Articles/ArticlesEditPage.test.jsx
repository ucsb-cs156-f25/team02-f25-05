  ...
  describe("tests where backend is working normally", () => {
    beforeEach(() => {
      ...
      axiosMock.onGet("/api/articles", { params: { id: 17 } }).reply(200, {
        ...
        explanation: "Helpful when we get stuck writing tests",
        email: "kennedynguyen@ucsb.edu",
        dateAdded: "2022-01-02T12:00:00",
      });
      axiosMock.onPut("/api/articles").reply(200, {
        id: "17",
        title: "Updated Testing Playground Article",
        url: "https://dev.to/updated-testing-playground",
    ...
    test("Is populated with the data provided", async () => {
      ...
      expect(explanationField).toHaveValue(
        "Helpful when we get stuck writing tests",
      );
      expect(emailField).toBeInTheDocument();
      expect(emailField).toHaveValue("kennedynguyen@ucsb.edu");
      ...
      fireEvent.change(titleField, {
        target: { value: "Updated Testing Playground Article" },
      });
      fireEvent.change(urlField, {
        target: { value: "https://dev.to/updated-testing-playground" },
      });
      fireEvent.change(explanationField, {
        target: { value: "Updated explanation for testing" },
      });
      ...
      expect(mockToast).toBeCalledWith(
        "Article Updated - id: 17 title: Updated Testing Playground Article",
      );
