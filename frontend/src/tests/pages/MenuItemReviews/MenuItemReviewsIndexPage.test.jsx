...
describe("MenuItemReviewsIndexPage tests", () => {
  ...
  test("renders three menu item reviews correctly for regular user", async () => {
    ...
    axiosMock
      ...
      .reply(200, menuItemReviewsFixtures.threeReviews);
    ...
    const reviewer = screen.getByText("test@example.com");
    expect(reviewer).toBeInTheDocument();

    const comments = screen.getByText("Very good");
    expect(comments).toBeInTheDocument();

    // for non-admin users, details may be visible but edit/delete should not
    expect(
