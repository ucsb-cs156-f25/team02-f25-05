...
|---------------------------|--------------|------------------|
| UCSBDiningCommonsMenuItem | Jasmine      | jasminetan0510   |
| UCSBOrganization          | Mon          | monraphael-maker |
| RecommendationRequest     | Hechenjin    | Hechenjin        |
| MenuItemReview            | Melvin       | amelvinmathew    |
| HelpRequest               | Brian        | bsen1            |
| Articles                  | Kennedy      | kennedynguyen1   |
